...
//      })
      ...
      .timeWindow(Time.seconds(30), Time.seconds(5)) //设置窗口
...
//class HotPageCountExtractor extends AssignerWithPunctuatedWatermarks[ApacheLogEvent] {
//
//
//  val bound = 10 * 1000 //最大乱序时间 10s
//
//
//  override def checkAndGetNextWatermark(lastElement: ApacheLogEvent, extractedTimestamp: Long): Watermark = {
